            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <?php if (session()->has('logged_in')): ?>
                        ...
                        <?php if (in_array(session('role'), ['admin', 'asisten'])): ?>
                            <li class="sidebar-item <?= ($route == 'siswa') ? 'active' : '' ?>">
                        ...
                        <?php if (session('role') === 'admin'): ?>
                            <!-- Menu khusus admin -->
                            <li class="sidebar-item <?= ($route == 'absensi') ? 'active' : '' ?>">
                            ...
                            <li class="sidebar-item <?= ($route == 'konfigurasi') ? 'active' : '' ?>">
                                <a href="/konfigurasi" class='sidebar-link'>
                        ...
                        <li class="sidebar-item mt-4">
                            <div class="sidebar-link text-muted">
                                <a href="/user/show/<?= esc(session('username')) ?>" class="d-flex align-items-center">
